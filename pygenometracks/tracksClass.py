...
class PlotTracks(object):
    ...
    def __init__(self, tracks_file, fig_width=DEFAULT_FIGURE_WIDTH,
        ...
        self.rc_context = {'font.size': fontsize}
        if fontfamily:
            ...
            self.rc_context['font.family'] = fontfamily
    ...
    def plot(self, file_name, chrom, start, end, title=None,
        ...
        track_height = self.get_tracks_height(start_region=start,
                                              end_region=end)
        rc_context = self.rc_context.copy()
        ...
        rc_context['pdf.fonttype'] = 42
        rc_context['ps.fonttype'] = 42
        with matplotlib.pyplot.rc_context(rc_context):
            if self.fig_height:
